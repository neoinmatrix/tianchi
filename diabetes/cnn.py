...
if __name__=="__main__":
    ...
    # ntest=test[test[u"血糖"]<7.0]
    # ntest=ntest.reset_index()
    # untest=test[test[u"血糖"]>=7.0]
    # untest=untest.reset_index()
    ...
    x_cols=[
       u'年龄', u'*天门冬氨酸氨基转换酶', u'*丙氨酸氨基转换酶', u'*碱性磷酸酶',
       u'*r-谷氨酰基转换酶', u'*总蛋白', u'白蛋白', u'*球蛋白', u'白球比例', u'甘油三酯', u'总胆固醇',
       u'高密度脂蛋白胆固醇', u'低密度脂蛋白胆固醇', u'尿素', u'肌酐', u'尿酸', u'红细胞计数', u'血红蛋白', u'红细胞压积',
    ...
    y_cols=u'血糖'
    params={
        'kf_n':5,'train':untrain,'test':test,
        'x_cols':x_cols,'y_cols':y_cols,
        'debug':True,'saved':True,
        'layer':(20,40),'alpha':1e-5,
    }
    frm(params)
    print "ok"