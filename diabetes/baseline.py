...
for i, (train_index, test_index) in enumerate(kf.split(train_feat.index)):
    ...
    # print train_feat1.head() ,categorical_feature=[u'性别']
    lgb_train1 = lgb.Dataset(train_feat1[predictors], train_feat1[u'血糖'],feature_name=predictors, categorical_feature=[u'性别'])
